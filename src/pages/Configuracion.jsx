  ...
  return (
    <div className="max-w-4xl space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Panel 1: Seguridad de la Cuenta */}
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col">
          ...
          <form className="space-y-4 flex-1 flex flex-col">
            <div>
              ...
              <input 
                type="text" 
                defaultValue="Gym Manager Central" 
            ...
            <div className="mt-auto pt-4">
              <button type="button" className="bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-lg font-medium transition-colors w-full flex justify-center items-center gap-2">
                <Save size={20} />
                Guardar Datos
              </button>
            </div>
